...
if ($module === '') {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' || $action === 'login' || isset($_GET['timeout']) || isset($_GET['login'])) {
        include __DIR__ . '/app/views/landingauth/index.php';
        exit();
    }
...
if ($module === 'cotizaciones') {
    ...
    switch ($action) {
        ...
        case 'cambiar_estado':
            ...
            break;
        case 'cambiar_entrega':
            $ctrl->cambiarEstadoEntrega();
            break;
        case 'estadisticas':
            require_once __DIR__ . '/app/controllers/EstadisticaController.php';
            require_once __DIR__ . '/app/models/EstadisticaModel.php';
