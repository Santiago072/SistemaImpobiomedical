...
class ProductoController
{
    ...
    public function crear(): array
    {
        ...
        if ($this->model->crear($titulo, $foto, $descripcion, $categoria, $codigo_producto)) {
    ...
    public function editar(): array
    {
        ...
        if ($this->model->actualizar($id, $titulo, $foto, $descripcion, $estado, $categoria, $codigo_producto)) {
